...
### Basic functionality similar to Anki (http://ankisrs.net/)
...
### What else I want
- web dictionary inegration
- offline dictionary inegration (wordnet db, etc.)
- desktop client app:
...
- Backend
  ...
  * Newtonsoft JSON (auxilary static db's)
- Frontend
